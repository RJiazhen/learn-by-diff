...
import { SnapshotDiffContentProvider, SNAPSHOT_DIFF_SCHEME } from "./ui/diff.ts";
...
export function activate(context: vscode.ExtensionContext): void {
  ...
  const snapshotDiff = new SnapshotDiffContentProvider();
  ...
  context.subscriptions.push(
    ...
    vscode.workspace.registerTextDocumentContentProvider(SNAPSHOT_DIFF_SCHEME, snapshotDiff),
  );
